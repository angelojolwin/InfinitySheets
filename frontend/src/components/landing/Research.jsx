      ...
      <div className="max-w-[1280px] mx-auto px-6 py-24 lg:py-28">
        <div className="max-w-[760px]">
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="text-[11px] tracking-[0.14em] uppercase font-semibold text-blue-700">Backed by research</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12">
          {RESEARCH_STATS.map((r, i) => (
            <div key={i} className="card-soft p-7">
              <div className="text-[44px] font-semibold tracking-tight text-violet-600 leading-none">{r.num}</div>
